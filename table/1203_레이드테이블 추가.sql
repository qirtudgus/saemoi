...
CREATE TABLE `raidboard` (
  ...
  PRIMARY KEY (`idx`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='레이드 게시판';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-03 17:13:09
